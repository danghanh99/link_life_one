...
class DanhSachNhanLaiVatLieuPage extends StatefulWidget {
  const DanhSachNhanLaiVatLieuPage({
    Key? key,
  }) : super(key: key);

  @override
  State<DanhSachNhanLaiVatLieuPage> createState() =>
      _DanhSachNhanLaiVatLieuPageState();
}

class _DanhSachNhanLaiVatLieuPageState
    extends State<DanhSachNhanLaiVatLieuPage> {

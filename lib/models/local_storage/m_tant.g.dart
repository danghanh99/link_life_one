...
class MTantAdapter extends TypeAdapter<MTant> {
  ...
  MTant read(BinaryReader reader) {
    ...
    return MTant(
      ...
      buzaiHacokFlg: fields[3] as String?,
      ...
      daylySales: fields[11] as String?,
      monthlySales: fields[12] as String?,
      kaisyuRuikei: fields[13] as String?,
      delFlg: fields[14] as String?,
...
MTant _$MTantFromJson(Map<String, dynamic> json) {
  ...
  return MTant(
    ...
    buzaiHacokFlg: json['BUZAI_HACOK_FLG'] as String?,
    ...
    daylySales: json['DAYLY_SALES'] as String?,
    monthlySales: json['MONTHLY_SALES'] as String?,
    kaisyuRuikei: json['KAISYU_RUIKEI'] as String?,
